...
class Menu extends React.Component {
  constructor() {
    ...
    _defineProperty(this, "dimensionsWindowSubscription", void 0);
    ...
    _defineProperty(this, "onWindowChangeHandler", _ref3 => {
      let {
        window
      } = _ref3;
      this.setState({
  ...
  componentDidMount() {
    ...
    this.dimensionsWindowSubscription = _reactNative.Dimensions.addEventListener('change', this.onWindowChangeHandler);
  }
  ...
  componentWillUnmount() {
    var _this$keyboardDidShow, _this$keyboardDidHide, _this$dimensionsWindo;
    this.removeListeners();
    ...
    (_this$dimensionsWindo = this.dimensionsWindowSubscription) === null || _this$dimensionsWindo === void 0 ? void 0 : _this$dimensionsWindo.remove();
  }
  render() {
    const {
      visible,
    ...
    if (left <= this.state.windowLayout.width - menuLayout.width - SCREEN_INDENT) {
    ...
    top >= this.state.windowLayout.height - menuLayout.height - SCREEN_INDENT - additionalVerticalValue &&
    // And bottom side of the screen has more space than top side
    top <= this.state.windowLayout.height - top) {
      // Scrollable menu should be below the anchor (expands downwards)
      scrollableMenuHeight = this.state.windowLayout.height - top - SCREEN_INDENT - additionalVerticalValue;
    } else if (
    // Check if the menu overflows from bottom side
    top >= this.state.windowLayout.height - menuLayout.height - SCREEN_INDENT - additionalVerticalValue &&
    ...
    scrollableMenuHeight = scrollableMenuHeight > this.state.windowLayout.height - 2 * SCREEN_INDENT ? this.state.windowLayout.height - 2 * SCREEN_INDENT : scrollableMenuHeight;
    ...
    top <= this.state.windowLayout.height - top) {
      ...
      if (bottom > this.state.windowLayout.height - SCREEN_INDENT) {
        top = scrollableMenuHeight === this.state.windowLayout.height - 2 * SCREEN_INDENT ? -SCREEN_INDENT * 2 : this.state.windowLayout.height - menuLayout.height - SCREEN_INDENT - additionalVerticalValue;
      }
    }

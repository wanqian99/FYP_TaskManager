...
declare const Checkbox: (import("react").ComponentType<Pick<import("./Checkbox").Props, "color" | "onPress" | "testID" | "disabled" | "status" | "uncheckedColor"> & {
    ...
    Item: import("react").ComponentType<Pick<import("./CheckboxItem").Props, "label" | "style" | "color" | "onPress" | "testID" | "disabled" | "accessibilityLabel" | "position" | "mode" | "status" | "labelStyle" | "uncheckedColor" | "labelVariant"> & {
        theme?: import("@callstack/react-theme-provider").$DeepPartial<unknown> | undefined;

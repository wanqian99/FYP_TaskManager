...
declare const RadioButton: (import("react").ComponentType<Pick<import("./RadioButton").Props, "color" | "onPress" | "testID" | "disabled" | "value" | "status" | "uncheckedColor"> & {
    ...
    Item: import("react").ComponentType<Pick<import("./RadioButtonItem").Props, "label" | "style" | "color" | "onPress" | "testID" | "disabled" | "accessibilityLabel" | "position" | "value" | "mode" | "status" | "labelStyle" | "uncheckedColor" | "labelVariant"> & {
        theme?: import("@callstack/react-theme-provider").$DeepPartial<unknown> | undefined;
